...
3. Create and set the values of the <pre><b>$USER_NAME</b></pre> and `$USER_PASSWORD` environment variables for the Spring Boot basic authentication default user.
